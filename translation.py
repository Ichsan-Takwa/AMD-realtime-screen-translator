...
class MarianMT:
    ...
    def generate_cache_key(text, target_language):
        # Buat kunci cache unik berdasarkan teks dan bahasa target
    ...
    def translate_text(self, text):
        ...
        # Cek apakah hasil translasi sudah ada dalam cache
        cached_translation = self.redis_client.get(cache_key)
        
        if cached_translation:
            return cached_translation.decode('utf-8')
        
        # Jika tidak ada dalam cache, lakukan translasi
        result = self.model.generate(**self.tokenizer(text, return_tensors="pt", padding=True))
        translated_text = self.tokenizer.decode(result[0], skip_special_tokens=True)
        
        # Simpan hasil translasi dalam cache
        self.redis_client.set(cache_key, translated_text)
        
        return translated_text

language_name_list = [
    ("guw", "Gunwinggu"), ("ar", "Arabic"), ("ig", "Igbo"), ("gmq", "Germanic"), ("eu", "Basque"), ("yap", "Yapese"),
    ("bzs", "Brazilian Sign Language"), ("hi", "Hindi"), ("zls", "Slavic"), ("it", "Italian"), ("cpf", "Creole French"),
    ("om", "Oromo"), ("urj", "Uralic"), ("wls", "Wallisian"), ("sla", "Slavic"), ("ve", "Venda"), ("rw", "Kinyarwanda"),
    ("ss", "Swati"), ("jap", "Japanese"), ("tw", "Twi"), ("gl", "Galician"), ("zh", "Chinese"), ("roa", "Romance"),
    ("hil", "Hiligaynon"), ("xh", "Xhosa"), ("ng", "Ndonga"), ("ha", "Hausa"), ("ur", "Urdu"), ("lv", "Latvian"),
    ("sal", "Salishan"), ("bi", "Bislama"), ("lua", "Luba-Lulua"), ("pap", "Papiamento"), ("lt", "Lithuanian"),
    ("prl", "Polabian"), ("alv", "Atlantic-Congo"), ("el", "Greek"), ("mk", "Macedonian"), ("ceb", "Cebuano"),
    ("cat_oci_spa", "Catalan Occitan Spanish"), ("zne", "Zande"), ("trk", "Turkic"), ("ja", "Japanese"), ("fi", "Finnish"),
    ("lun", "Lunda"), ("ru", "Russian"), ("bg", "Bulgarian"), ("da", "Danish"), ("gem", "Germanic"), ("NORTH_EU", "North Europe"),
    ("bcl", "Central Bikol"), ("ts", "Tsonga"), ("iso", "Isoko"), ("is", "Icelandic"), ("cel", "Celtic"), ("tiv", "Tiv"),
    ("kj", "Kuanyama"), ("tvl", "Tuvalu"), ("tut", "Altaic"), ("run", "Rundi"), ("iir", "Indo-Iranian"), ("bnt", "Bantu"),
    ("tdt", "Tetun Dili"), ("fr", "French"), ("ilo", "Ilokano"), ("niu", "Niuean"), ("tpi", "Tok Pisin"), ("aed", "Argentine Sign Language"),
    ("pt", "Portuguese"), ("poz", "Malayo-Polynesian"), ("ms", "Malay"), ("mh", "Marshallese"), ("fiu", "Finno-Ugric"),
    ("hu", "Hungarian"), ("sq", "Albanian"), ("sem", "Semitic"), ("he", "Hebrew"), ("rnd", "Rundi"), ("bat", "Baltic"),
    ("gv", "Manx"), ("sw", "Swahili"), ("th", "Thai"), ("pag", "Pangasinan"), ("ho", "Hiri Motu"), ("srn", "Sranan Tongo"),
    ("ht", "Haitian"), ("ZH", "Chinese"), ("ga", "Irish"), ("bem", "Bemba"), ("tl", "Tagalog"), ("en_el_es_fi", "English Greek Spanish Finnish"),
    ("tll", "Tetela"), ("de", "German"), ("zle", "East Slavic"), ("ml", "Malayalam"), ("pqe", "Eastern Malayo-Polynesian"),
    ("grk", "Greek"), ("umb", "Umbundu"), ("csg", "Chilean Sign Language"), ("sh", "Serbo-Croatian"), ("ty", "Tahitian"),
    ("mkh", "Mon-Khmer"), ("sk", "Slovak"), ("sg", "Sango"), ("lus", "Lushai"), ("id", "Indonesian"), ("eo", "Esperanto"),
    ("SAMI", "Sami"), ("gil", "Gilbertese"), ("ca", "Catalan"), ("chk", "Chuukese"), ("yua", "Yucatec Maya"), ("rn", "Kirundi"),
    ("dra", "Dravidian"), ("mt", "Maltese"), ("csn", "Colombian Sign Language"), ("tr", "Turkish"), ("loz", "Lozi"),
    ("st", "Southern Sotho"), ("mr", "Marathi"), ("fj", "Fijian"), ("itc", "Italic"), ("toi", "Tonga"), ("sit", "Sino-Tibetan"),
    ("efi", "Efik"), ("NORWAY", "Norwegian"), ("swc", "Congo Swahili"), ("tum", "Tumbuka"), ("uk", "Ukrainian"),
    ("lg", "Ganda"), ("tzo", "Tzotzil"), ("ase", "American Sign Language"), ("ro", "Romanian"), ("map", "Austronesian"),
    ("mfs", "Mexican Sign Language"), ("pon", "Pohnpeian"), ("ROMANCE", "Romance"), ("es", "Spanish"), ("ln", "Lingala"),
    ("cs", "Czech"), ("vi", "Vietnamese"), ("nic", "Niger-Congo"), ("euq", "Basque"), ("CELTIC", "Celtic"), ("nyk", "Nyaneka"),
    ("phi", "Philippine"), ("SCANDINAVIA", "Scandinavian"), ("nl", "Dutch"), ("ine", "Indo-European"), ("ber", "Berber"),
    ("zlw", "West Slavic"), ("cy", "Welsh"), ("crs", "Seselwa Creole French"), ("sm", "Samoan"), ("pis", "Pijin"),
    ("en", "English"), ("sl", "Slovene"), ("gmw", "West Germanic"), ("lue", "Luvale"), ("mg", "Malagasy"), ("fse", "Finnish Sign Language"),
    ("no", "Norwegian"), ("gaa", "Ga"), ("zai", "Zairean Creole"), ("inc", "Indic"), ("mfe", "Morisyen"), ("af", "Afrikaans"),
    ("ces_slk", "Czech Slovak"), ("pqw", "Western Malayo-Polynesian"), ("cpp", "Creole Portuguese"), ("cus", "Cushitic"),
    ("kwy", "Koryak"), ("hr", "Croatian"), ("az", "Azerbaijani"), ("to", "Tongan"), ("hy", "Armenian"), ("yo", "Yoruba"),
    ("sn", "Shona"), ("sv", "Swedish"), ("afa", "Afro-Asiatic"), ("ee", "Ewe"), ("pl", "Polish"), ("kqn", "Kaonde"),
    ("nso", "Northern Sotho"), ("ny", "Nyanja"), ("ko", "Korean"), ("mos", "Mossi"), ("tn", "Tswana"), ("lu", "Luba-Katanga"),
    ("luo", "Luo"), ("ti", "Tigrinya"), ("et", "Estonian"), ("kwn", "Kwangali"), ("kg", "Kongo"), ("aav", "Austroasiatic"),
    ("mul", "Multiple languages"), ("war", "Waray"), ("law","Laos")
]
language_pairs = {'fi': ['en',
  'uk',
  'zle',
  'zls',
  'zne',
 ...
 'fr': ['pag',
  ...
  'ar',
  'af'],
 'pl': ['uk', 'sv', 'no', 'lt', 'fr', 'es', 'eo', 'en', 'de', 'ar'],
 'rn': ['en', 'ru', 'fr', 'es', 'de'],
 'taw': ['en'],
 'az': ['en', 'tr', 'es'],
 'tr': ['en', 'uk', 'uk', 'sv', 'lt', 'fr', 'es', 'eo', 'en', 'az', 'ar'],
 'bat': ['zle', 'en'],
 'hu': ['uk', 'en', 'uk', 'sv', 'fr', 'fi', 'eo', 'en', 'de'],
 'zle': ['bat',
  'gmq',
  'pt',
  'fi',
 ...
 'ro': ['uk', 'sv', 'fr', 'fi', 'eo'],
 'gmw': ['gmw', 'gmw', 'gmw', 'en'],
 'zlw': ['fiu', 'zle', 'en', 'zlw', 'en'],
 'gmq': ['he', 'zle', 'tr', 'zlw', 'ar', 'itc', 'gmq', 'en', 'gmq', 'en'],
 'ar': ['gmq',
  'itc',
  'en',
  'tr',
  ...
  'el',
  'de'],
 'itc': ['eu', 'ar', 'he', 'tr', 'itc', 'bat', 'itc', 'en'],
 'zls': ['itc', 'zle', 'de', 'en', 'zls', 'en'],
 'he': ['itc',
  'gmq',
  'en',
  'uk',
 ...
 'it': ['zle',
  ...
  'bg',
  'ar'],
 'pt': ['zle', 'uk', 'tl', 'gl', 'eo', 'ca'],
 'fa': ['itc', 'gmq'],
 'eu': ['itc', 'ru', 'es', 'en', 'de'],
 'lv': ['en', 'sv', 'ru', 'fr', 'fi', 'es', 'en'],
 'bg': ['en',
  'uk',
  'tr',
  'sv',
 ...
 'zh': ['ja',
  ...
  'de',
  'bg'],
 'lt': ['en', 'tr', 'sv', 'ru', 'pl', 'it', 'fr', 'es', 'eo', 'de'],
 'ko': ['en', 'sv', 'ru', 'hu', 'fr', 'fi', 'es', 'en', 'de'],
 'et': ['en', 'sv', 'ru', 'fr', 'fi', 'es', 'en', 'de'],
 'sh': ['en', 'uk', 'eo'],
 'el': ['en', 'sv', 'fr', 'fi', 'eo', 'ar'],
 'ces_slk': ['en', 'uk'],
 'cat_oci_spa': ['en'],
 'zne': ['sv', 'fr', 'fi', 'es'],
 'zai': ['es'],
 ...
 'nyk': ['en'],
 'ny': ['es', 'en', 'de'],
 'nso': ['sv', 'fr', 'fi', 'es', 'en', 'de'],
 'no': ['uk', 'sv', 'ru', 'pl', 'no', 'nl', 'fr', 'fi', 'es', 'de', 'da'],
 'nl': ['uk', 'sv', 'no', 'fr', 'fi', 'es', 'eo', 'en', 'ca', 'af'],
 'niu': ['sv', 'fr', 'fi', 'es', 'en', 'de'],
 'nic': ['en'],
 'ng': ['en'],
 'mul': ['en'],
 'mt': ['sv', 'fr', 'fi', 'es', 'en'],
 ...
 'ja': ['vi',
  ...
  'ar'],
 'iso': ['sv', 'fr', 'fi', 'es', 'en'],
 'is': ['sv', 'it', 'fr', 'fi', 'es', 'eo', 'en', 'de'],
 'ine': ['ine', 'en'],
 'inc': ['inc', 'en'],
 'ilo': ['sv', 'fi', 'es', 'en', 'de'],
 'iir': ['iir', 'en'],
 'ig': ['sv', 'fr', 'fi', 'es', 'en', 'de'],
 'id': ['sv', 'fr', 'fi', 'es', 'en'],
 'hy': ['ru', 'en'],
 'ht': ['sv', 'fr', 'fi', 'es', 'en'],
 'hr': ['sv', 'fr', 'fi', 'es'],
 ...
 'ha': ['sv', 'fr', 'fi', 'es', 'en'],
 'gv': ['en'],
 'guw': ['sv', 'fr', 'fi', 'es', 'en', 'de'],
 'grk': ['en'],
 'gl': ['pt', 'es', 'en'],
 'gil': ['sv', 'fr', 'fi', 'es', 'en'],
 'gem': ['gem', 'en'],
 'gaa': ['sv', 'fr', 'fi', 'es', 'en', 'de'],
 'ga': ['en'],
 'fse': ['fi'],
 'fj': ['fr', 'en'],
 'fiu': ['fiu', 'en'],
 'fi_nb_no_nn_ru_sv_en': ['SAMI'],
 'euq': ['en'],
 'eo': ['sv',
  'sh',
  'ru',
  ...
  'bg',
  'af'],
 'en_el_es_fi': ['en_el_es_fi'],
 'efi': ['sv', 'fr', 'fi', 'en', 'de'],
 'ee': ['sv', 'fr', 'fi', 'es', 'en', 'de'],
 'dra': ['en'],
 'da': ['ru', 'no', 'fr', 'fi', 'es', 'eo', 'en', 'de'],
 'cy': ['en'],
 'csn': ['es'],
 'csg': ['es'],
 'cs': ['uk', 'sv', 'fr', 'fi', 'eo', 'en', 'de'],
 'crs': ['sv', 'fr', 'fi', 'es', 'en', 'de'],
 'cpp': ['en', 'cpp'],
 'cpf': ['en'],
 'chk': ['sv', 'fr', 'es', 'en'],
 'ceb': ['sv', 'fr', 'fi', 'es', 'en'],
 'cau': ['en'],
 'ca': ['uk', 'pt', 'nl', 'it', 'fr', 'es', 'en', 'de'],
 'bzs': ['sv', 'fr', 'fi', 'es', 'en'],
 'bnt': ['en'],
 'bn': ['en'],
 'bi': ['sv', 'fr', 'es', 'en'],
 ...
 'bem': ['sv', 'fr', 'fi', 'es', 'en'],
 'be': ['es'],
 'bcl': ['sv', 'fr', 'fi', 'es', 'en', 'de'],
 'ase': ['sv', 'fr', 'es', 'en', 'de'],
 'art': ['en'],
 'am': ['sv'],
 'alv': ['en'],
 'afa': ['en', 'afa'],
 'af': ['sv', 'ru', 'nl', 'fr', 'fi', 'es', 'eo', 'en', 'de'],
 'aed': ['es'],
 'aav': ['en'],
...
language_to_id = {name: id for id, name in language_name_list}
id_to_language = {id: name for id, name in language_name_list}
source_language = {id_to_language[id] for id in language_pairs.keys()}